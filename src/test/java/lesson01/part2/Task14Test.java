...
public class Task14Test {
    ...
    public void test14_2() {
        ...
        Assert.assertFalse("Не пройдено 2е условие!",
                        collect.get(23).contains("System.out.print")&& collect.get(24).contains("System.out.print")
                                &&collect.get(25).contains("System.out.print")&&collect.get(26).contains("System.out.print"));
    }
